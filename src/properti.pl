...
:- dynamic(property/8).
% :- include('player.pl').
propertyValue('A1',15,37,75,150,168,10,25,50,75,100).
propertyValue('A2',15,40,78,156,175,10,27,52,78,105).
propertyValue('A3',15,43,81,162,182,10,29,54,81,110).
propertyValue('B1',30,45,90,180,202,20,30,60,90,115).
propertyValue('B2',30,48,93,186,209,20,32,62,93,120).
propertyValue('B3',30,51,96,192,216,20,34,64,96,125).
propertyValue('C1',45,54,108,216,243,30,36,72,108,130).
propertyValue('C2',45,57,111,222,249,30,38,74,111,135).
propertyValue('C3',45,60,114,228,256,30,40,76,114,140).
propertyValue('D1',60,64,129,259,291,40,43,86,129,145).
propertyValue('D2',60,67,132,265,298,40,45,88,132,150).
propertyValue('D3',60,70,135,271,305,40,47,90,135,155).
propertyValue('E1',75,77,155,311,349,50,51,103,155,160).
propertyValue('E2',75,80,158,317,356,50,53,105,158,165).
propertyValue('E3',75,83,161,323,363,50,55,107,161,170).
propertyValue('F1',90,93,186,373,419,60,62,124,186,190).
propertyValue('F2',90,96,189,379,426,60,64,126,189,200).
propertyValue('F3',90,99,192,385,433,60,66,128,192,215).
propertyValue('G1',105,111,223,447,503,70,74,149,223,230).
propertyValue('G2',105,114,226,453,510,70,76,151,226,245).
propertyValue('G3',105,117,229,459,517,70,78,153,229,260).
propertyValue('H1',120,134,268,537,604,80,89,179,268,280).
propertyValue('H2',120,137,271,543,611,80,91,181,271,300).
